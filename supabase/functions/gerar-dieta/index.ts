...
const MENUS_BASE: Record<string, any> = {
  iniciante: [
    {
      nome: "Modelo 1 - Prático",
      refeicoes: [
  ...
  avancado: [
    {
      nome: "Modelo 1 - Atleta Performance",
      refeicoes: [
    ...
    {
      nome: "Modelo 2 - Atleta Densidade",
      refeicoes: [
...
MENUS_BASE["alto_nivel"] = MENUS_BASE["avancado"];
