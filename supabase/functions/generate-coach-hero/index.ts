...
COMPOSITION:
- The coach from the FIRST reference image stands on the RIGHT side of the frame, cropped from mid-thigh/waist up, arms crossed or relaxed confident stance, direct gaze at camera, cinematic rim lighting.
...
- BACKGROUND: a moody dark gym / studio with dramatic light beams, subtle haze and deep shadows.${temLogo ? `\n- The SECOND reference image is the COACH'S OWN LOGO. Render that exact logo LARGE behind the coach as a glowing backdrop element (centered-left behind the subject, partially occluded by his/her body), like a stage backdrop or projected brand wall. Keep the logo's exact shapes, letters and proportions — do not redesign it.` : ""}
