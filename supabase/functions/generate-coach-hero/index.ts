...
COMPOSITION:
- The coach from the FIRST reference image is anchored in the RIGHT CORNER of the frame, LARGE and PROMINENT (cropped from mid-thigh/waist up), arms crossed, direct gaze at camera, cinematic rim lighting. Keep the coach firmly on the RIGHT side — do NOT shift the coach toward the center. The coach's body is positioned so it is fully visible and sits IN FRONT of the dashboard cards, not hidden behind them.
