      ...
      <main className="px-5 pb-16 -mt-2 space-y-5">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <Button
              className={`h-11 font-display text-base uppercase tracking-wider ${
                canGenerate 
          ...
          <Button
            variant="outline"
            className={`w-full h-11 font-display text-base uppercase tracking-wider border-primary/30 text-primary hover:bg-primary/5 ${
