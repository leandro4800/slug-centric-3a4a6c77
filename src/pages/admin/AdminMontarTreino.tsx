                    ...
                    <div className="relative flex items-center justify-between gap-2 px-4 pt-5 pb-3">
                      <div className="flex items-center gap-2.5 min-w-0 flex-1">
                        <select
                          ...
                          onChange={(ev) => moveDiaPara(dia, parseInt(ev.target.value, 10))}
                      ...
                      <div key={globalIdx} className="bg-secondary/30 border border-border/60 rounded-lg p-3 space-y-2.5 relative">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-0.5">
                            <select
                              value={localIdx + 1}
                              title="Posição — escolha para mover"
                              className="h-7 w-11 rounded-md border border-border/60 bg-background/60 text-center text-xs"
                              onChange={(ev) => {
