      ...
      <div className="relative h-[460px] min-h-[58vh] overflow-hidden bg-gradient-to-b from-background via-[hsl(0_0%_4%)] to-background">
        ...
        <div className="absolute bottom-5 left-5 right-5">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <p className="text-[11px] text-muted-foreground uppercase tracking-[0.2em]">Leitura educacional de exames</p>
          </div>
        </div>
      </div>
      ...
      <Dialog open={pasteOpen} onOpenChange={setPasteOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Cole os resultados laboratoriais (nome do marcador, valor e unidade). A IA vai interpretar de forma educacional.
            </DialogDescription>
          </DialogHeader>
          <Textarea
            value={pasteText}
