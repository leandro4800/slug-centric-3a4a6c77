...
export default function Planos() {
  return (
    <IOSDesktopOnlyGate
      title="Planos e Stripe pelo computador"
      description="A criação de planos e sincronização com Stripe deve ser feita no painel web pelo seu computador, fora do app iOS."
      desktopHint="alpha-coach.app/site/admin/planos"
    >
