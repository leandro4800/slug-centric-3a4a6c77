        ...
        <div>
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-xs font-bold uppercase tracking-wider transition-all hover:border-primary hover:text-primary disabled:opacity-50"
            >
