...
export const DIVISOES_PRESETS: DivisaoPreset[] = [
  ...
  { id: "ppl-2x", label: "PPL 6x — Push/Pull/Legs 2x semana", freq: 6, publico: "unisex", nivel: ["Avançado", "Atleta de Alto Nível"], dias: ["Push A", "Pull A", "Legs A (Quad)", "Push B", "Pull B", "Legs B (Posterior)"] },
