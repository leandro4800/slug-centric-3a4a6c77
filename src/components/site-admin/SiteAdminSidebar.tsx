...
import {
  ...
  ChevronLeft, ChevronRight, Video, ShieldCheck, Crown, HeartPulse, BookOpen,
} from "lucide-react";
...
const baseItems: Item[] = [
  ...
  { to: "/site/admin/base-conhecimento", label: "Base de Conhecimento", icon: BookOpen, section: "Programação" },
